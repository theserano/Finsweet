        ...
        <Box sx={{ width: '100%' }}>
            ...
            <CustomTabPanel value={value} index={0}>
                <p className="paragraph_small">
                    Lorem clasem ipsum dolor sit amet, consectetur adipiscing
                    elit. Suspendisse varius enim in eros elementum tristique.
                    Duis cursus, mi quis viverra ornare, eros dolor interdum
                    nulla, ut commodo diam libero vitae erat.
                    <br /> Aenean faucibus nibh et justo cursus id rutrum lorem
            ...
            <CustomTabPanel value={value} index={1}>
                <p className="paragraph_small">
                    ...
                    Suspendisse ornare, eros dolor interdum nulla, ut commodo
