    ...
    <div className="donate">
        ...
        <header className="donate_header">
            <div className="donate_header_container container mx-auto">
                <div ref={headerLeftRef} className={`donate_header_container_left ${headerLeft ? "donate_header_container_left_show" : ""}`}>
                ...
                <div ref={headerRightRef} className={`donate_header_container_right ${headerRight ? "donate_header_container_right_show" : ""}`}>
        ...
        <div className="donate_contribute container mx-auto">
            <div ref={dontLeftRef} className={` donate_contribute_left ${dontLeft ? "donate_contribute_left_show" : ""}`}>
            ...
            <div ref={dontRightRef} className={`donate_contribute_right ${dontRight ? "donate_contribute_right_show" : ""}`}>
                <DonateTabs />
            </div>
        </div>

        <div ref={duseRef} className={`donation_use container mx-auto mb-28 ${dUse ? "donation_use_show" : ""}`}>
