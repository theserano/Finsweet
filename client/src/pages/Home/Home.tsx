    ...
    return (
        <div className="home">
            <div className="home_header_container">
                <div
                    ref={headerRef}
                    className={`home_header container mx-auto ${header ? 'home_header_show' : ''}`}
                >
            ...
            <section className="home_know container mx-auto">
                <article className="home_know_top">
                    ...
                    <div className="home_know_top_left">
                        ...
                        >
                            ...
                            <p className="paragraph_small">
                                ...
                                erat. Aenean faucibus nibh et justo cursus id
                                rutrum lorem imperdiet. Nunc ut sem vitae risus
                                tristique posuere.
                            </p>
                            <button
                    ...
                    <div className="home_know_top_right">
                        <button
                            ref={homeVideoRef}
                            className={`home_know_top_right_video ${slideVideo ? 'home_know_top_right_video_show' : ''}`}
            ...
            <section className="home_what_section">
                ...
                <section className="home_what container mx-auto">
                    ...
                    <article className="home_what_left">
                        ...
                        <div
                            ref={whatBottomRef}
                            className={`home_what_left_bottom ${slideWhatBottom ? 'home_what_left_bottom_show' : ''}`}
                        >
            ...
            <section className="projects container mx-auto">
                ...
                <h1 className="heading_two">
                    We are Creating sustainable society, for everyone and
                    forever.
                </h1>
                <article
                    ref={cardsRef}
            ...
            <section className="home_spend_container">
                <section className="home_spend container mx-auto">
                    ...
                    <article
                        ref={spendRef}
                        className={`home_spend_left ${spendSlide ? 'home_spend_left_show' : ''}`}
                    >
                        <h1 className="heading_one">
                            How we spend your donations and where it goes
                        </h1>
                        <p className="paragraph">
                            We understand that when you make a donation, you
                            want to know exactly where your money is going and
