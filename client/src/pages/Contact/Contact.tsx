        ...
        <div className="contact">
            <header className="contact_header">
                <div className="contact_header_container container mx-auto">
                    <div
                        ref={headerLeftRef}
                        className={`contact_header_container_left ${headerLeft ? 'contact_header_container_left_show' : ''}`}
                    >
                    ...
                    <div
                        ref={headerRightRef}
                        className={`contact_header_container_right ${headerRight ? 'contact_header_container_right_show' : ''}`}
                    >
            ...
            <form className="contact_form">
                {/* name block */}
                {error && (
                    <p className="paragraph_small contact_error">
                        Something went wrong
                    </p>
                )}
                {done && (
                    <p className="paragraph_small success">
                        Thank you for filling the form
                    </p>
                )}
                <div className="contact_form_top">
                    <div className="contact_form_top_name">
                        <label className="paragraph_small" htmlFor="fName">
                            First Name
                        </label>
                        <input
                            className="paragraph"
                        ...
                        {emptyF && (
                            <p
                                className={`${emptyF ? 'paragraph_small contact_error' : ''}`}
                            >
                    ...
                    <div className="contact_form_top_name">
                        <label className="paragraph_small" htmlFor="lName">
                            Last Name
                        </label>
                        <input
                            className="paragraph"
                        ...
                        {emptyL && (
                            <p
                                className={`${emptyL ? 'paragraph_small contact_error' : ''}`}
                            >
                                Field cannot be empty
                            </p>
                        )}
                ...
                <div className="contact_form_middle">
                    <div className="contact_form_middle_email">
                        <label className="paragraph_small" htmlFor="email">
                            Email
                        </label>
                        <input
                            className="paragraph"
                        ...
                        {emptyE && (
                            <p
                                className={`${emptyE ? 'paragraph_small contact_error' : ''}`}
                            >
                                Field cannot be empty
                            </p>
                        )}
                    ...
                    <div className="contact_form_middle_email">
                        <label className="paragraph_small" htmlFor="subject">
                            Subject
                        </label>
                        <input
                            className="paragraph"
                        ...
                        {emptyS && (
                            <p
                                className={`${emptyS ? 'paragraph_small contact_error' : ''}`}
                            >
                                Field cannot be empty
                            </p>
                        )}
                ...
                <div className="contact_form_bottom">
                    <label className="paragraph_small" htmlFor="message">
                        Message
                    </label>
                    <textarea
                        className="paragraph"
                    ...
                    {emptyM && (
                        <p
                            className={`${emptyM ? 'paragraph_small contact_error' : ''}`}
                        >
                            Field cannot be empty
                        </p>
                    )}
                </div>
                <button className="green_btn" onClick={handleContactSubmit}>
                    Send message
                </button>
            </form>
            ...
            <div className="map_responsive">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.173280324398!2d3.3736769758848837!3d6.499735123437224!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b8c6109587b1f%3A0xdd6210419ac6bf44!2sThe%20Nest%20Lounge!5e0!3m2!1sen!2sng!4v1710346171210!5m2!1sen!2sng"
                    width="600"
                    height="450"
                    allowFullScreen
                    loading="lazy"
