    ...
    return (
        <div className="events">
                ...
                <div className="events_header_container container mx-auto">
                    ...
                    <div className="events_header_container_dates">
                        <p className="paragraph_small">
                            <img src={location} alt="stuff" />8 Brewery Drive,
                            Hudson, NH 03051, USA
                        </p>
                        <p className="paragraph_small">
                            <img src={date} alt="stuff" />8 Brewery Drive,
                            Hudson, NH 03051, USA
                        </p>
                    </div>
                </div>
            ...
            <div className="events_details container mx-auto">
                ...
                <img
                    src="https://res.cloudinary.com/dfltu5jw4/image/upload/v1710439819/Images_vfntwm.png"
                    alt="event"
                />
                <p className="paragraph">
                    Et morbi vitae lobortis nam odio. Faucibus vitae vel neque
