        ...
        <div className="media">
            <header className="media_header">
                ...
                <div className="media_header_container container mx-auto">
                    ...
                    <div
                        ref={headerLeftRef}
                        className={`media_header_container_left ${headerLeft ? 'media_header_container_left_show' : ''}`}
                    >
                    ...
                    <div
                        ref={headerRightRef}
                        className={`media_header_container_right ${headerRight ? 'media_header_container_right_show' : ''}`}
                    >
                        <div className="media_header_container_right_div">
                            <div className="media_header_container_right_div_image">
                                <img
                                    src="https://res.cloudinary.com/dfltu5jw4/image/upload/v1709891618/finsweet/home/Image_grepy9.png"
                                    alt="stuff"
                                />
                            </div>
                            <div className="media_header_container_right_div_details">
                                <h4 className="heading_four">
                                    Don't destroy greenery and don't spoil
                                    scenery.
                                </h4>
                                <p className="paragraph_small">
                        ...
                        <div className="media_header_container_right_div">
                            <div className="media_header_container_right_div_image">
                                <img
                                    src="https://res.cloudinary.com/dfltu5jw4/image/upload/v1709891616/finsweet/home/Image_1_lz782y.png"
                                    alt="stuff"
                                />
                            </div>
                            <div className="media_header_container_right_div_details">
                        ...
                        <div className="media_header_container_right_div">
                            <div className="media_header_container_right_div_image">
                                <img
                                    src="https://res.cloudinary.com/dfltu5jw4/image/upload/v1709891616/finsweet/home/Image_2_grgpaj.png"
                                    alt="stuff"
                                />
                            </div>
                            <div className="media_header_container_right_div_details">
                                <h4 className="heading_four">
                                    Caring for the present is caring for the
                                    future
                                </h4>
                                <p className="paragraph_small">
                                    Lorem ipsum dolor sit amet, consectetur
            ...
            <div className="media_read container mx-auto px-8">
                ...
                <p className="paragraph_small text-center mb-16">
