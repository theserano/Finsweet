    ...
    return (
        <div className="blog">
            <header className="blog_header container mx-auto">
                ...
                <p className="paragraph_samll text-center">
                    Mauris morbi sed dignissim a in nec aliquam fringilla et.
                    Mattis elit dignissim nibh sit.
                </p>
                <img
                    className="blog_header_image"
                    src="https://res.cloudinary.com/dfltu5jw4/image/upload/v1710437340/Image_xykxp2.png"
                    alt="stuff"
                />
            </header>
            ...
            <div className="blog_details container mx-auto my-20">
                ...
                <p className="paragraph_small">
                    ...
                    molestie in turpis quam. Scelerisque in viverra mi ut
                    quisque. In sollicitudin sapien, vel nulla quisque vitae.
                    Scelerisque eget accumsan, non in. Posuere magna erat
                ...
                <p className="paragraph_small">
                    ...
                    cras.Mauris morbi sed dignissim a in nec aliquam fringilla
                    et. Mattis elit dignissim nibh sit. Donec arcu sed elit
                ...
                <p className="paragraph_small mb-12">
                    ...
                    enim, eget ut sit purus, justo nisl pharetra. Tincidunt leo
                    aenean dui, varius metus, vel. Maecenas eu rhoncus, est nunc
                    nisi volutpat, amet venenatis faucibus. Enim, vel nunc purus
                    feugiat purus tincidunt neque. Massa ultricies faucibus
                    pellentesque risus duis est.
                </p>
                <h4 className="heading_three">
                ...
                <ul className="mb-12 list-disc pl-12">
                    <li>
                        ...
                        neque nullam in in lorem platea mattis.
                    </li>
                    <li>
                        Viverra at diam nunc non ornare. Sed ultricies pulvinar
                        nunc, lacus sem. Tellus aliquam ut euismod cursus dui
                    ...
                    <li>
                        Mauris morbi sed dignissim a in nec aliquam fringilla
                        et.
                    </li>
